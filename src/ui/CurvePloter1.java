 ...
 * @author JianGe
 */
public class CurvePloter1 extends JPanel {
    ...
    // Constructor
    //
    public CurvePloter1(Dimension preferSize, String title, SingleFileCurveSets singleFileCurveSets) {
    ...
    private void drawChart(ChartViewer viewer) {
        ...
        Logs.e("viewPortStart: " + viewPortStartDate.toString() + ", viewPortEnd: " + viewPortEndDate.toString());
