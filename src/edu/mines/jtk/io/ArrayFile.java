 ...
 * arrays of primitive values, such as ints and floats. Also, array files may be
 * read or written with either BIG_ENDIAN or LITTLE_ENDIAN byte orders.
 * <p>
 ...
 * (as for a {@link java.io.RandomAccessFile}). Alternatively, an array file can
 * be constructed from an existing {@link java.io.RandomAccessFile}.
 *
...
public class ArrayFile implements ArrayInput, ArrayOutput, Closeable {
    ...
    /**
     * Constructs an array file with specified name, access mode, and byte
     * orders.
     *
     * @param name the file name.
     * @param mode the access mode; "r", "rw", "rws", or "rwd".
    ...
    /**
     * Constructs an array file with specified file, access mode, and byte
     * orders.
     *
     * @param file the file.
     * @param mode the access mode; "r", "rw", "rws", or "rwd".
    ...
    /**
     * Constructs an array file for a specified random-access file and byte
     * orders.
     *
    ...
    /**
     * Reads a byte value from this file. The returned value will be in the
     * range 0 to 255.
     *
    ...
    /**
     * Gets the file pointer (byte offset) for this file. The next read or write
    ...
    /**
     * Sets the file pointer (byte offset) for this file. The next read or or
     ...
     *
     * @param off the file pointer, the offset in bytes from the beginning of
     * the file.
     */
    ...
    /**
     * Sets the length of this file. If the current file length exceeds the
     * specified new length, then the file will be truncated. In this case, if
     * the file pointer exceeds the new length, then that pointer will equal to
     * the new length when this methods returns.
     * <p>
     * If the current file length is less than the specified new length, then
     * this file will extended. The content of the extended portion is
     * undefined.
     *
    ...
    /**
     * Reads byte elements into a specified array. The array length equals the
    ...
    /**
     * Reads char elements into a specified array. The array length equals the
     * number of elements to read.
     *
     * @param v the array.
     */
    ...
    /**
     * Reads short elements into a specified array. The array length equals the
     * number of elements to read.
     *
     * @param v the array.
     */
    ...
    /**
     * Reads int elements into a specified array. The array length equals the
     * number of elements to read.
     *
     * @param v the array.
     */
    ...
    /**
     * Reads long elements into a specified array. The array length equals the
     * number of elements to read.
     *
     * @param v the array.
     */
    ...
    /**
     * Reads float elements into a specified array. The array length equals the
     * number of elements to read.
     *
     * @param v the array.
     */
    ...
    /**
     * Reads double elements into a specified array. The array length equals the
     * number of elements to read.
     *
     * @param v the array.
     */
    ...
    /**
     * Writes byte elements from a specified array. The array length equals the
    ...
    /**
     * Writes char elements from a specified array. The array length equals the
     * number of elements to write.
     *
     * @param v the array.
     */
    ...
    /**
     * Writes shorts elements from a specified array. The array length equals
    ...
    /**
     * Writes int elements from a specified array. The array length equals the
     * number of elements to write.
     *
     * @param v the array.
     */
    ...
    /**
     * Writes long elements from a specified array. The array length equals the
     * number of elements to write.
     *
     * @param v the array.
     */
    ...
    /**
     * Writes float elements from a specified array. The array length equals the
     * number of elements to write.
     *
     * @param v the array.
     */
    ...
    /**
     * Writes double elements from a specified array. The array length equals
     * the number of elements to write.
     *
     * @param v the array.
     */
