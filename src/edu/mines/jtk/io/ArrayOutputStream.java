...
public class ArrayOutputStream
    ...
    /**
     * Constructs an array output stream for the specified stream. The default
    ...
    /**
     * Constructs an array output stream for the specified file name. The
    ...
    /**
     * Constructs an array output stream for the specified file. The default
     * byte order is BIG_ENDIAN.
     *
     * @param file the file.
     */
    ...
    /**
     * Constructs an array output stream for the specified stream and byte
     * order.
     *
     * @param os the output stream.
    ...
    /**
     * Constructs an array output stream for the specified file name and byte
     * order. The default byte order is BIG_ENDIAN.
     *
     * @param name the file name.
     * @param bo the byte order.
     */
