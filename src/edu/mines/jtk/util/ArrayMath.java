...
// Newly extracted function from java.lang.Math
    ...
    // ramp
    /**
     * Returns an array initialized to a specified linear ramp. Array values are
     * ra+i1*rb1.
     *
    ...
    /**
     * Sets the specified array with a specified linear ramp. Array values are
     * ra+i1*rb1.
     *
     * @param ra value of the first element.
     * @param rb1 gradient in 1st dimension.
    ...
    /**
     * Determines whether all elements in two specified arrays are equal, to
    ...
    // isRegular
    /**
     * Determines whether the specified array of arrays is regular. The array is
     * regular if each of its elements, which are arrays, have the same length.
     *
     * @param a the array.
     ...
     * increasing if its elements a[i] increase with array index i, with no
     * equal values.
     *
     * @param a the array.
     ...
     * decreasing if its elements a[i] decrease with array index i, with no
     * equal values.
     *
     * @param a the array.
     ...
     * monotonic if its elements a[i] either increase or decrease (but not both)
     * with array index i, with no equal values.
     *
     * @param a the array.
     ...
     * @param a the array of values, assumed to be monotonic.
     * @param x the value for which to search.
     * @param i the index at which to begin the search. If negative, this method
     * interprets this index as if returned from a previous call.
     * @return the index at which the specified value is found, or, if not
     * found, -(i+1), where i equals the index at which the specified value
     * would be located if it was inserted into the monotonic array.
     */
